...
import { ArrowLeft, Calendar, GraduationCap, Quote, Star, User, Instagram, AlertCircle } from "lucide-react";
      ...
      <div className="flex flex-col min-h-screen">
        <main className="my-10 flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">Data awardee tidak ditemukan.</p>
            <Button asChild>
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[50vh] min-h-[400px]">
          <div className="absolute inset-0">
            <Image
              src={awardee.coverImage ? urlFor(awardee.coverImage).url() : "/images/placeholder-cover.jpg"}
              alt={awardee.name ? `Foto sampul ${awardee.name}` : "Foto sampul awardee"}
              fill
          ...
          <div className="container relative h-full flex flex-col justify-end pb-12 z-10">
            <div className="flex flex-col md:flex-row items-start md:items-end gap-6">
              <div className="relative h-32 w-32 md:h-40 md:w-40 rounded-xl overflow-hidden border-4 border-white shadow-xl">
                <Image src={awardee.image ? urlFor(awardee.image).url() : "/images/placeholder-avatar.png"} alt={awardee.name ? `Foto ${awardee.name}` : "Foto awardee"} fill className="object-cover" sizes="160px" />
              </div>
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-2">
                  ...
                  {awardee.role && (
                    <div className="flex items-center">
                      ...
                      <span className="text-white/90">{awardee.role}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-10">
                ...
                {awardee.bio && (
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">{awardee.bio}</p>
                  </div>
                )}
                ...
                {awardee.testimonial && (
                  <div className="bg-primary/5 dark:bg-primary/10 p-8 rounded-xl">
                    ...
                    <blockquote className="text-lg italic text-muted-foreground mb-4 leading-relaxed">{awardee.testimonial}</blockquote>
                    <div className="flex items-center">
              ...
              <div className="space-y-8">
                ...
                {/* Connect */}
                {awardee.socialMedia && Object.values(awardee.socialMedia).some(Boolean) && (
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <h3 className="font-semibold text-lg mb-4">Media Sosial</h3>
                    <div className="space-y-3">
                      {awardee.socialMedia.instagram && (
                        <Button asChild variant="outline" className="w-full justify-start">
                          <Link href={awardee.socialMedia.instagram} target="_blank" rel="noopener noreferrer" aria-label="Kunjungi Instagram">
                      ...
                      {awardee.socialMedia.linkedin && (
                        <Button asChild variant="outline" className="w-full justify-start">
                          <Link href={awardee.socialMedia.linkedin} target="_blank" rel="noopener noreferrer" aria-label="Kunjungi LinkedIn">
                      ...
                      {awardee.socialMedia.twitter && (
                        <Button asChild variant="outline" className="w-full justify-start">
                          <Link href={awardee.socialMedia.twitter} target="_blank" rel="noopener noreferrer" aria-label="Kunjungi Twitter">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2">
                              <title>X</title>
                      ...
                      {awardee.socialMedia.github && (
                        <Button asChild variant="outline" className="w-full justify-start">
                          <Link href={awardee.socialMedia.github} target="_blank" rel="noopener noreferrer" aria-label="Kunjungi GitHub">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2">
                              <title>GitHub</title>
        ...
        <section className="py-8 border-t">
          <div className="container">
            <Button asChild variant="outline">
              <Link href="/awardees" tabIndex={0} aria-label="Kembali ke daftar awardee">
